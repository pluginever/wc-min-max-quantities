...
final class WCMinMaxQuantities {
    ...
    public function __clone() {
        _doing_it_wrong( __FUNCTION__, __( 'Cloning is forbidden.', 'wc-min-max-quantities' ), '1.0.0' );
    }
    ...
    public function __wakeup() {
        _doing_it_wrong( __FUNCTION__, __( 'Unserializing instances of this class is forbidden.', 'wc-min-max-quantities' ), '2.1' );
    }
    ...
    public function localization_setup() {
        load_plugin_textdomain( 'wc-min-max-quantities', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
    }
