				...
				'sections' => array(
					'main' => array(
						...
						'fields' => array(
							...
							array(
								'title'   => esc_html__( 'Minimum cart amount', 'wc-minmax-quantities' ),
								'id'      => 'min_order_amount',
								'desc'    => esc_html__( 'Minimum cart total. Set zero for no restrictions.', 'wc-minmax-quantities' ),
								'type'    => 'number',
								'default' => '0',
							),
							array(
								'title'   => esc_html__( 'Maximum Cart amount', 'wc-minmax-quantities' ),
								'id'      => 'max_order_amount',
								'desc'    => esc_html__( 'Maximum cart total.Set zero for no restrictions.', 'wc-minmax-quantities' ),
								'type'    => 'number',
								'default' => '0',
							),
						),
