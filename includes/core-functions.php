...
function wc_min_max_quantities_proceed_to_checkout_conditions()
{
	...
	$min_cart_total_price = wc_minmax_quantities_get_settings('min_cart_total_price', 0);
	$max_cart_total_price = wc_minmax_quantities_get_settings('max_cart_total_price', 0);
