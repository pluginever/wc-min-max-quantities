...
class WC_Minmax_Quantites_Admin_Settings extends WC_Admin_Settings {
	...
	public static function get_settings_pages() {
		if ( empty( self::$settings ) ) {
			...
			$settings[] = include( 'settings/wc-minmax-quantities-settings-general.php' );
			...
			self::$settings[] = include( 'settings/wc-minmax-quantities-settings-help.php' );
		}
	...
	public static function save() {
		...
		if ( empty( $_REQUEST['_wpnonce'] ) || ! wp_verify_nonce( $_REQUEST['_wpnonce'], 'wc-minmax-quantities-settings' ) ) {
			die( __( 'Action failed. Please refresh the page and retry.', 'woocommerce' ) );
		}

		// Trigger actions
		do_action( 'wc_minmax_quantities_settings_save_' . $current_tab );
		do_action( 'wc_minmax_quantities_update_options_' . $current_tab );
		do_action( 'wc_minmax_quantities_update_options' );
		...
		do_action( 'wc_minmax_quantities_settings_saved' );
	}
	...
	public static function output() {
		...
		$tabs = apply_filters( 'wc_minmax_quantities_settings_tabs_array', array() );
