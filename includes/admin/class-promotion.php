...
class WC_MINMAX_Promotion {
	...
	public function promotional_offer() {
		...
		$hide_notice = get_option( 'wc_minmax_initial_upsell_promotion', 'hide' );
        ...
        <div class="notice notice-info is-dismissible" id="wc_minmax-promotional-offer-notice">
            <p>Thank you for installing
                <strong><a href="https://pluginever.com/plugins/woocommerce-min-max-quantities-pro/" target="_blank">WC
                        Min Max Quantities</a></strong>,
                Use the coupon code <strong>WCMINMAXFREE2PRO</strong> for 10% discount on PRO.
                <a href="https://pluginever.com/plugins/woocommerce-min-max-quantities-pro/?utm_source=plugin_activation_notice&utm_medium=link&utm_campaign=wc-minmax-numbers&utm_content=Get%20the%20Offer"
