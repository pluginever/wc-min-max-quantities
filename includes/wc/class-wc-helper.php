<?php
/**
 * Handles WooCommerce helper functionalities.
 *
 * @version  1.1.0
 * @since    1.1.0
	...
	public static function get_product_limits( $product_id, $variation_id = 0 ) {
		...
		if ( false === $limits ) {
			...
			if ( $override ) {
				...
				$limits['step']    = (int) Helper::get_option( 'product_quantity_step', 0 );
				$limits['min_qty'] = (int) Helper::get_option( 'min_product_quantity', 0 );
				$limits['max_qty'] = (int) Helper::get_option( 'max_product_quantity', 0 );
			}
